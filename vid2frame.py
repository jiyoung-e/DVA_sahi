...
def parse_video_to_frames(video_path, output_base_folder_path):
    ...
    output_folder_path = os.path.join(output_base_folder_path, filename_without_ext)
...
# Example usage
video_folder = '/home/dva3/workspace/input_demo_video'  # Replace with the path to your video folder
output_base_folder = '/home/dva3/workspace/output/test1203'  # Replace with the base path to your output folder

# Call the function
parse_videos_multithreaded(video_folder, output_base_folder)